...
?>
    ...
    <body>
                ...
                <div class="formdky">
                    ...
                    <form method="POST" role="form" name="dky">
                        <table>
                            ...
                            <tr>
                                <td><input type="text" name="username" size="20" id="" ></td>
                            </tr>
        ...
        if (isset($_POST["sbt"]))  //khi bấm vào submit là chạy
        {
            ...
            {
                echo '<script language="javascript">alert("Vui Lòng Nhập Đúng SĐT!"); </script>';
                //header("Refresh:0");
            } 
                ...
                $sqltt = "INSERT INTO `taikhoan` VALUES ('$insert_id','$username','$password','$email','$hoten','$diachi','$gioitinh','$SDT','$usertype') ";
